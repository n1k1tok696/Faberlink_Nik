...
<main>
    ...
    <section class="design_concept">
      ...
      <div class="blocks-in-row">
        <div>
          <img src="images/design_concept/Union1.png" alt="Union1">
          <div>
        ...
        <div>
          <img src="images/design_concept/Union2.png" alt="Union2">
          <div>
        ...
        <div>
          <img src="images/design_concept/Union3.png" alt="Union3">
          <div>
    ...
    <section class="how-to-get">
      <div>
        <img src="images/fone.jpg" alt="Another image">
      </div>
      <div class="steps">
    ...
    <section class="principles design_concept">
      ...
      <div class="blocks-in-row">
        <div>
          <img src="images/principles/principles1.png" alt="Union1">
          <div>
            <h2>Kreativität</h2>
            <p>
        ...
        <div>
          <img src="images/principles/principles2.png" alt="Union1">
          <div>
        ...
        <div>
          <img src="images/principles/principles3.png" alt="Union1">
          <div>
        ...
        <div>
          <img src="images/principles/principles4.png" alt="Union1">
          <div>
            <h2>Effizienz</h2>
            <p>
        ...
        <div>
          <img src="images/principles/principles5.png" alt="Union1">
          <div>
      ...
      <div class="left-column">
        <div>
          <div class="image-feedback">
            <img src="images/fone.jpg" alt="Feedback">
          </div>
    ...
    <section class="needs design_concept">
      ...
      <div class="blocks-in-row">
        <div>
          <img src="images/needs/needs1.png" alt="Union1">
          <div>
        ...
        <div>
          <img src="images/needs/needs2.png" alt="Union2">
          <div>
        ...
        <div>
          <img src="images/needs/needs3.png" alt="Union3">
          <div>
            <h2>Ihr Projekt</h2>
            <p>
    ...
    <section class="brands">
      ...
      <div class="carousel">
        ...
        <div class="companies">
          <div>
            <div>
              <img src="images/brands/brand1.png" alt="brand-logo">
            </div>
          ...
          <div>
            <div>
              <img src="images/brands/brand2.png" alt="brand-logo">
            </div>
          ...
          <div>
            <div>
              <img src="images/brands/brand3.png" alt="brand-logo">
            </div>
          ...
          <div>
            <div>
              <img src="images/brands/brand4.png" alt="brand-logo">
            </div>
